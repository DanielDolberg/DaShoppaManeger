...
public class CustomerManager {
    ...
    public static JSONArray getCustomerData() throws IOException {
        // # String content = new String(Files.readAllBytes(Paths.get(JSONHandler.CustomersJsonFilePath)));
        JSONObject json = JSONHandler.readFrom(JSONHandler.CustomersJsonFilePath);
    ...
    public static void addCustomer(JSONObject newCustomer) throws IOException {
        ...
        try (FileWriter file = new FileWriter(JSONHandler.CustomersJsonFilePath)) {
